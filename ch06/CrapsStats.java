package ch06;// Statistical simulation of craps
    ...
    implements ActionListener
{
  ...
  private JTextField numberIn, statsOut, percentOut;
  ...
  public CrapsStats()
  {
    ...
    percentOut = new JTextField(18);
    percentOut.setEditable(false);
    c.add(percentOut);
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    percentOut.setText(" Win ratio: " + (winCount/(double)gameCount));
  }

  public static void main(String args[])
  {
    CrapsStats window = new CrapsStats();
    window.setBounds(100, 100, 300, 110);
